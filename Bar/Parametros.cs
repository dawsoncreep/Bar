...
namespace Bar
{
    public partial class Parametros : Form
    {
        ...
        {
            DataSet1TableAdapters.SP_tabla_parametroTableAdapter tpta = new Bar.DataSet1TableAdapters.SP_tabla_parametroTableAdapter();
        ...
        private string validate()
        {
           ...
           if (txtDesc.Text.Trim().Length == 0)
            ...
            {
                DataSet1TableAdapters.SP_tabla_parametroTableAdapter usuta = new Bar.DataSet1TableAdapters.SP_tabla_parametroTableAdapter();
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (btnActualizar.Text == "Guardar")
            {
                ...
                if (valida == "OK")
                {
                    try
                    {
                        DataSet1TableAdapters.SP_tabla_parametroTableAdapter usudta = new Bar.DataSet1TableAdapters.SP_tabla_parametroTableAdapter();
            ...
            else
            {
                ...
                try
                {
                    ...
                    DataSet1TableAdapters.SP_tabla_parametroTableAdapter prodta = new Bar.DataSet1TableAdapters.SP_tabla_parametroTableAdapter();
